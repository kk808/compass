<?= $this->setVar('title', 'Welcome to CodeIgniter 4!')->extend('layouts/main') ?>
...
<?= $this->section('styles') ?>
    ...
    <style {csp-style-nonce}>
        ...
        *:focus {
        ...
        .welcome-header .heroe {
            margin: 0 auto;
            max-width: 1100px;
            padding: 1rem 1.75rem 1.75rem 1.75rem;
        }
        .welcome-header .heroe h1 {
            font-size: 2.5rem;
            font-weight: 500;
        }
        .welcome-header .heroe h2 {
            font-size: 1.5rem;
            font-weight: 300;
        }
        section {
...
<header class="welcome-header">
    ...
    <div class="heroe">
        ...
        <h1>Welcome - CodeIgniter v<?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
